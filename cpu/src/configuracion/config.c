...
void iniciar_logger(){
    logger_cpu = log_create(PATH_ABSOLUTO("cpu/logs/cpu.log"),"cpu",0,LOG_LEVEL_INFO);
    logger_errores_cpu = log_create(PATH_ABSOLUTO("cpu/logs/cpu_errores.log"),"errores_cpu",0,LOG_LEVEL_INFO);
