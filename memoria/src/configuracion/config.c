...
void iniciar_logger(){
    logger_memoria = log_create("../memoria/logs/memoria.log","Memoria",0,LOG_LEVEL_INFO);
    logger_conexiones = log_create("../memoria/logs/conexiones.log","Conexion",0,LOG_LEVEL_INFO);
}
